...
const NAV = [
  ...
  { to: "/competencias", label: "Competências", icon: CalendarRange },
      ...
      <aside className="hidden w-64 shrink-0 flex-col bg-sidebar text-sidebar-foreground md:flex">
        <div className="px-6 py-6">
          <div className="text-lg font-extrabold tracking-tight text-sidebar-accent-foreground">
            P&amp;A <span className="text-sidebar-primary">Consultoria</span>
          </div>
          <p className="mt-1 text-xs text-sidebar-foreground/70">Contabilidade inteligente</p>
        </div>
        ...
        <div className="px-6 py-4 text-xs text-sidebar-foreground/60">MVP · Módulo 01</div>
      </aside>
